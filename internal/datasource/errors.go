...
var (
	...
	ErrInvalidCrawlInterval      = errors.New("invalid crawl_interval_minutes; must be greater than 0")
	...
	ErrInvalidTargetInterval      = errors.New("invalid crawl_interval_minutes; must be omitted or greater than 0")
