...
var (
	...
	ErrDispatchConflict      = errors.New("execution.repository: dispatch already running for target")
	ErrUpdateDispatch        = errors.New("execution.repository: failed to update dispatch")
	ErrCancelRuntime         = errors.New("execution.repository: failed to cancel runtime")
