...
# SMAP Ingest Consumer - Build and Push to Zot Registry
...
show_help() {
    cat <<EOF
${GREEN}SMAP Ingest Consumer - Build & Push (Zot Registry)${NC}
...
Environment Variables:
    ...
    ZOT_PASSWORD   Registry pass    (default: from script)
